...
- Unused _exports_ are deliberately not gated. There are 98, mostly barrel re-exports, and that is a separate piece of work. `npm run deadcode:all` surfaces them.
