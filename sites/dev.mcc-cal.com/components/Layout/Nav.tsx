          ...
          <div className="mcc-nav__menu">
            <ul className="mcc-nav__links" id="mcc-nav-links" role="list">
              <li className="mcc-nav__link mcc-nav__link--has-submenu">
                <Link href="/" data-match="^/" aria-current={isHome ? 'page' : undefined}>
                  Work
                </Link>
                <button
                ...
                >
                  <li>
                    <Link href="/journalism" role="menuitem">
                      Photojournalism
                    </Link>
                  </li>
                  <li>
                    <Link href="/concerts" role="menuitem">
                      Concert
                    </Link>
                  </li>
                  <li>
                    <Link href="/events" role="menuitem">
                      Event
                    </Link>
                  </li>
                  <li>
                    <Link href="/nature" role="menuitem">
                      Nature
                    </Link>
                  </li>
                </ul>
              ...
              <li className="mcc-nav__link">
                <Link
                  href="/abridged"
                  data-match="^/abridged"
                  aria-current={isAbridged ? 'page' : undefined}
                >
                  Abridged App
                </Link>
              </li>
              <li className="mcc-nav__link">
                <Link
                  href="/podcast"
                  data-match="^/podcast"
                  aria-current={isPodcast ? 'page' : undefined}
                >
                  Podcast
                </Link>
              </li>
