...
const Nav: React.FC = () => {
  ...
  const isAbridged = useMemo(() => regexMatch('^/abridged', pathname), [pathname]);
          ...
          <div className="mcc-nav__menu">
            <ul className="mcc-nav__links" id="mcc-nav-links" role="list">
              <li className="mcc-nav__link mcc-nav__link--has-submenu">
                ...
                >
                  <li>
                    <Link to="/journalism" role="menuitem">Photojournalism</Link>
                  </li>
                  <li>
                    <Link to="/concerts" role="menuitem">Concert</Link>
                  </li>
                  <li>
                    <Link to="/events" role="menuitem">Event</Link>
                  </li>
                  <li>
                    <Link to="/nature" role="menuitem">Nature</Link>
                  </li>
                </ul>
              </li>
              <li className="mcc-nav__link">
                <Link to="/abridged" aria-current={isAbridged ? 'page' : undefined}>
                  Abridged App
                </Link>
              </li>
              <li className="mcc-nav__link">
                <Link to="/podcast" aria-current={isPodcast ? 'page' : undefined}>
                  Podcast
                </Link>
              </li>
              <li className="mcc-nav__link">
