      ...
      <div className="mcc-footer-widget">
        <footer className="mcc-footer" role="contentinfo" aria-label="Site footer">
            ...
            <section className="mcc-footer__section" aria-labelledby="footer-follow">
              ...
              <div className="mcc-footer__newsletter">
                <form
                  ...
                  noValidate
                >
                  <label className="mcc-footer__sr-only" htmlFor="mcc-footer-email">
                    Email address
                  </label>
                  <input
                    id="mcc-footer-email"
                  ...
                  <div style={{ position: 'absolute', left: '-5000px' }} aria-hidden="true">
                    <input
                      type="text"
                      name="b_da029ed85760894c33e8b119d_fb992a38c8"
                      tabIndex={-1}
                      defaultValue=""
                    />
                  </div>
          ...
          <div className="mcc-footer__legal">
            <div>
              &copy; <span>{year}</span> Caleb McCartney. All rights reserved.
            </div>
            <div className="mcc-footer__links">
              <a href="/accessibility">Accessibility</a>
              <a href="/accessibility#cookies-overview">Cookie Policy</a>
            </div>
          </div>
        </footer>
      </div>
