...
export const HERO_IMAGE_VARIANTS: Record<string, HeroSlideVariant[]> = {
  ...
  Pittsburgh: [
    {
      image: imageUrl.nature('Landscapes/Downtown Pittsburgh', '211028_Pittsburgh_Sunset_IMGP7702_webuse.webp'),
      alt: 'Clouds gather over Pittsburgh\'s riverfront at sunset.',
      focalPointMobile: { x: 0.5, y: 0.58 },
      focalPointDesktop: { x: 0.5, y: 0.62 },
    },
    {
      image: imageUrl.nature('Landscapes/Downtown Pittsburgh', '211028_Downtown_Fire_Escape_IMGP7594_webuse.webp'),
    ...
    {
      image: imageUrl.nature('Landscapes/Downtown Pittsburgh', '200805_Riverfront_Golden_Hour_DSC02724_1_webuse.webp'),
