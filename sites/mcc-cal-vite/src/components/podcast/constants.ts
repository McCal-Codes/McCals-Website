...
export const CALENDLY = '/book-a-podcast'; // Updated to use internal booking system
export const CACHE_KEY = 'podcast-feed-v2.5';
...
export const FALLBACK: Episode[] = [
  {
    ...
    platformUrl: 'https://rss.com/podcasts/cafeconnectpod/2289545',
  ...
  },
  {
    ...
    platformUrl: 'https://rss.com/podcasts/cafeconnectpod/2205662',
  ...
  },
  {
    ...
    platformUrl: 'https://rss.com/podcasts/cafeconnectpod/2031736',
  ...
  },
  {
    ...
    platformUrl: 'https://rss.com/podcasts/cafeconnectpod/2030795',
  ...
  },
  {
    ...
    platformUrl: 'https://rss.com/podcasts/cafeconnectpod/1990167',
    audioUrl: '',
    episodeNumber: '5',
    episodeType: 'full',
    transcripts: [],
  },
  {
    ...
    platformUrl: 'https://rss.com/podcasts/cafeconnectpod/1990129',
    audioUrl: '',
    episodeNumber: '4',
    episodeType: 'full',
    transcripts: [],
