...
grep -q '<?xml version="1.0"' dist/sitemap.xml && echo "✓ Valid XML"
```
...
- ✅ After adding new photos (automatic via CI)
- ✅ After changing portfolio structure
- ✅ After updating manifest formats
- ✅ When API endpoints change
- ✅ When site URL changes

---

**🎯 Your SEO is automated and always current!**
