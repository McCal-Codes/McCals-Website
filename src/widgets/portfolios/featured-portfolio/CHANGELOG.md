...
## v1.5.1 - 2026-01-06 [LCP Optimized]

- **LCP Optimization**: Pre-rendered LCP candidate (Horseburner) in HTML to ensure immediate visibility.
- **Layout Stability**: Modified shuffle logic to pin the pre-rendered item to the top, preventing layout shifts.
- **Performance**: Enforced `loading="eager"` and `fetchpriority="high"` for the LCP image.
- **UX**: Removed blocking loading spinner for perceived instant load.
