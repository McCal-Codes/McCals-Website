...
1. Copy the latest file from `versions/` (e.g., `v1.2.0-hero-slideshow.html`).
2. Paste into a Squarespace Code Block on the landing page.
3. Update image sources and captions via data attributes.

## Notes

- Keep the wrapper `div.mccal-hero` intact for scoped styles and script.
