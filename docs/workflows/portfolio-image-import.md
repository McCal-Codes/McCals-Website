...
## 2. Export with rights metadata

Before adding web-ready files to the repo, export portfolio images with basic IPTC rights metadata from Lightroom, Photo Mechanic, Photoshop, or the editing tool used for final delivery.

Use these fields for public portfolio exports:

- Creator/Artist: `Caleb McCartney`
- Credit: `McCal Media`
- Copyright Notice: `Copyright (c) Caleb McCartney / McCal Media. All rights reserved.`
- Web Statement of Rights: `https://mcc-cal.com/policies-legal`

This metadata is provenance and rights hygiene, not download prevention. Optimized web derivatives, CDN transforms, screenshots, and social platforms may strip metadata, so the website also uses an invisible portfolio image shield to reduce casual right-click, drag, and long-press saving.

## 3. Update the per-portfolio manifest
...
## 4. Refresh the universal manifest
