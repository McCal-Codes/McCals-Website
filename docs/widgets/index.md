...
- Nature Portfolio — latest `v1.8.0-performance-optimized.html`; see `src/widgets/portfolios/nature-portfolio/README.md`
- Video Portfolio — latest `v0.1.0-video-portfolio.html`; see `src/widgets/portfolios/video-portfolio/README.md`
- About — see `src/widgets/_content/about/README.md` (latest version noted inside)
- Podcast Feed — see `src/widgets/_content/podcast-feed/README.md`
- Hero Slideshow — see `src/widgets/_content/hero-slideshow/README.md`
- Site Footer — see `src/widgets/_navigation/site-footer/README.md`
- Site Navigation — see `src/widgets/_navigation/site-navigation/README.md`
